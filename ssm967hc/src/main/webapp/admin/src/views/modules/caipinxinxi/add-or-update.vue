    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="菜品详情" prop="caipinxiangqing">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.caipinxiangqing" label="菜品详情" prop="caipinxiangqing">
                    <span>{{ruleForm.caipinxiangqing}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.cantingbianhao!=''&&json.cantingbianhao){
                this.ruleForm.cantingbianhao = json.cantingbianhao
	    		this.ro.cantingbianhao = true;
		}
		...
		if(json.cantingdizhi!=''&&json.cantingdizhi){
                this.ruleForm.cantingdizhi = json.cantingdizhi
	    		this.ro.cantingdizhi = true;
		}
        } else {
