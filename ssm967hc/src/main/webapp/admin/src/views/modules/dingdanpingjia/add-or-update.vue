<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="配送评分" prop="peisongpingfen">
          <el-select :disabled="ro.peisongpingfen" v-model="ruleForm.peisongpingfen" placeholder="请选择配送评分">
            <el-option
                v-for="(item,index) in peisongpingfenOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="配送评分" prop="peisongpingfen">
	      <el-input v-model="ruleForm.peisongpingfen"
                placeholder="配送评分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="内容反馈" prop="neirongfankui">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="内容反馈"
                  v-model="ruleForm.neirongfankui" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.neirongfankui" label="内容反馈" prop="neirongfankui">
                    <span>{{ruleForm.neirongfankui}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  data() {
	...
	shhf : false,
      ...
      rules: {
          ...
          neirongfankui: [
                { required: true, message: '内容反馈不能为空', trigger: 'blur' },
          ],
          pingjiariqi: [
          ],
          yonghuming: [
