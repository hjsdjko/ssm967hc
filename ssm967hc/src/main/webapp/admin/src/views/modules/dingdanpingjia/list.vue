  ...
  <div class="main-content">
    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
		...
		<el-form-item class="select" label="菜品评分" prop="caipinpingfen">
		  <el-select  @change="caipinpingfenChange" clearable v-model="searchForm.caipinpingfen" placeholder="请选择菜品评分">
		    <el-option
			...
			:value="item">
              ...
              <el-form-item :label="contents.inputTitle == 1 ? '评价日期' : ''">
                  <el-date-picker
                      v-model="searchForm.pingjiariqistart"
                      type="date"
			...
			format="yyyy-MM-dd"
                  ...
                  至
                  <el-date-picker
                      v-model="searchForm.pingjiariqiend"
                      type="date"
			value-format="yyyy-MM-dd" 
			format="yyyy-MM-dd"
                      placeholder="评价日期结束">
    ...
    getDataList() {
      ...
      let params = {
        ...
        sort: 'id',
          ...
          if(this.searchForm.caipinpingfen!='' && this.searchForm.caipinpingfen!=undefined){
    ...
    shDialog(row){
      ...
      if(row){
        this.shForm = {
          ...
          peisongpingfen: row.peisongpingfen,
          peisonggonghao: row.peisonggonghao,
          neirongfankui: row.neirongfankui,
