	...
	<view class="content my-publish-pv">
		<form>
			<view class="cu-form-group">
				...
				<input :style='{"padding":"0 20rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"12rpx 0","borderColor":"rgba(16, 55, 94, 1)","backgroundColor":"rgba(255, 255, 255, 0)","color":"#333","textAlign":"left","borderRadius":"0","borderWidth":"2rpx 2rpx 2rpx 8rpx","width":"100%","fontSize":"28rpx","borderStyle":"solid","height":"68rpx"}' disabled="true" v-model="ruleForm.username" placeholder="留言人用户名"></input>
			</view>
			<view class="cu-form-group">
				<!-- <view :style="userInfoForm.list.title" class="title">留言内容</view> -->
				<textarea :style='{"padding":"20rpx","boxShadow":"0 0 0px rgba(0,0,0,.6) inset","margin":"12rpx 0","borderColor":"rgba(16, 55, 94, 1)","backgroundColor":"rgba(255, 255, 255, 0)","color":"#333","borderRadius":"0","borderWidth":"2rpx 2rpx 2rpx 8rpx","width":"100%","fontSize":"28rpx","borderStyle":"solid","height":"300rpx"}' v-model="ruleForm.content" placeholder="留言内容"></textarea>
			</view>
			...
			<view class="cu-form-group" style="text-align:center">
				<button :style='{"padding":"0 20rpx","boxShadow":"0 0 16rpx rgba(0,0,0,0) inset","margin":"20rpx auto","borderColor":"#409EFF","backgroundColor":"rgba(189, 223, 229, 1)","color":"rgba(0, 0, 0, 1)","borderRadius":"88rpx","borderWidth":"0","width":"60%","fontSize":"28rpx","borderStyle":"solid","height":"80rpx"}' @tap="onSubmitTap" class="bg-red margin-tb-sm">提交</button>
			</view>
		</form>
	</view>
</template>
	...
	export default {
		...
		async onLoad(options) {
			...
			this.ruleForm.userid = uni.getStorageSync("userid")
            						                                    if(table == `waimaiyuan`){
                this.ruleForm.username = this.user.peisonggonghao
            }
                                                                                                                                                						            						                                    if(table == `canting`){
                this.ruleForm.username = this.user.cantingbianhao
            }
                                                                                                                                                                        						            						                                    if(table == `yonghu`){
...
<style lang="scss" scoped>
	...
	.content:after {
		...
		bottom: 0;
		content: '';
				background-image: url(http://codegen.caihongy.cn/20220221/69c6e14eb7854b04a8c28d853f214abe.png);
