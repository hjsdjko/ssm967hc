...
public class CantingController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		CantingEntity user = cantingService.selectOne(new EntityWrapper<CantingEntity>().eq("cantingbianhao", username));
    ...
    public R register(@RequestBody CantingEntity canting){
    	...
    	CantingEntity user = cantingService.selectOne(new EntityWrapper<CantingEntity>().eq("cantingbianhao", canting.getCantingbianhao()));
		if(user!=null) {
