...
public class DingdanpeisongController {
    ...
    public R page(@RequestParam Map<String, Object> params,DingdanpeisongEntity dingdanpeisong, 
		...
		if(tableName.equals("canting")) {
			dingdanpeisong.setCantingbianhao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("yonghu")) {
			dingdanpeisong.setYonghuming((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("waimaiyuan")) {
			dingdanpeisong.setPeisonggonghao((String)request.getSession().getAttribute("username"));
		}
