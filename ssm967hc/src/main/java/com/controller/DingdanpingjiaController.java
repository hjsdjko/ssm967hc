...
public class DingdanpingjiaController {
    ...
    public R page(@RequestParam Map<String, Object> params,DingdanpingjiaEntity dingdanpingjia, 
		...
		if(tableName.equals("canting")) {
			dingdanpingjia.setCantingbianhao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("waimaiyuan")) {
			dingdanpingjia.setPeisonggonghao((String)request.getSession().getAttribute("username"));
		}
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		if(tableName.equals("waimaiyuan")) {
			wrapper.eq("peisonggonghao", (String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("yonghu")) {
